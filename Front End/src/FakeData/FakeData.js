...
import monitor1A from '../images/products/monitor.jpg'
import sandal1 from '../images/products/sandal.jpg'
import halfShirt1 from '../images/products/half-shirt.jpg'
import bookbag1 from '../images/products/bookbag.jpg'
import shoes1 from '../images/products/shoes1.png'
import shoes2 from '../images/products/yellow-shoes-2.jpg'
import tshirt2 from '../images/products/shirt-full.jpg'
import watch1 from '../images/products/watch-1.webp'
import honey1 from '../images/products/honey.jpg'
import ring1 from '../images/products/ring.jpg'
import tomato1 from '../images/products/tomato.jpg'

const FakeData = [
    {
        id:1,
        name:'Men`s Cotton Short Sleeve Multi-Colour T-Shirt Icon Fashion B ',
        img:tshirt1,
        price:65,
        brand:"No Brand",
        category:'T-shirt',
        ratings:4.5,
        allReviews:[
            {user:"sohelrana",review:"The product is not orginal, please don'y buy it!"},
            {user:"developer",review:"amazing product!!"},
        ],
        color:'Multi Color',
    ...
    },
    {
        ...
        ratings:4.5,
        allReviews:[
            {user:"saidur rahman",review:"not bad with this price"},
        ],
        color:'Familiy Blue',
        description:"This product comes with very attractive design. The material used in it will meet your expectation and need also. Now with a new look it is even better than before and its quality will definitely meet your desire. So you may take this to bring smile and enjoy the feel of good quality product.",
        quantity:1
    ...
    {
        id:3,
        name:'Mens Life Style Belt Sandal - Black ',
        img:sandal1,
        price:299,
        brand:"Latto",
        category:'Shoes',
        ratings:5,
        allReviews:[
            {user:"guist user",review:"all is okay for this price"},
        ],
        color:'Family Blue',
        description:"",
        size:[39,40,41,42],
    ...
    {
        id:4,
        name:'Stylish Regular Smart Formal Huf shirt For men ',
        img:halfShirt1,
        price:345,
        brand:"Latto",
        category:'Shoes',
    ...
    {
        id:5,
        name:'Outdoor Small Mini Backpack Daypack Bookbags Laptop bag 10L ',
        img:bookbag1,
        price:121,
        brand:"No Brand",
        category:'bag',
        ratings:4.5,
        allReviews:[
            {user:"shakib",review:"awesome"},
            {user:"al amin",review:"good product"},
            {user:"manunul alam",review:"thanks to seller for the original product"},
        ],
        color:'Multi color',
    ...
    {
        id:6,
        name:'Comfortable Sports Sneakers 2022 Stylish Lace up Trendy Shoes for man',
        img:shoes1,
        price:365,
        brand:"No Brand",
        category:'shoes',
    ...
    {
        id:7,
        name:'SNEAKERS FOR MEN WATER PROOF KOREAN MESH BREATHABLE LIGHT WEIGHT TRENDY SHOES FOR MEN',
        img:shoes2,
        price:286,
        brand:"No Brand",
        category:'shoes',
        ...
        allReviews:[
            ...
            {user:"zaman",review:"recommended to all"},
            {user:"Sohel Rana",review:"beautiful product"},
        ],
        color:'yellow',
        description:"Product details of Trendy Shoes For Man With High Quality Fabrics And Breathable Outdoor Sport Sneakers Lightweight Air Mesh Men ShoesSneaker for men. Shoes for men. Summer sneaker. Summer shoes for men. shoes for men 2022 Running shoes Casual shoes Sports breathable shoes gym shoes for men walking shoes",
        quantity:1
    ...
    {
        id:8,
        name:'Men`s Cotton Casual Half Sleeve Shirt',
        img:tshirt2,
        price:199,
        brand:"No Brand",
        category:'shirt',
        ratings:4.1,
        allReviews:[
            {user:"jahangir alam",review:"looks very nice, color is awesome"},
        ],
        color:'Multi color',
        size:["M", "L", "XL"],
        description:"Product details of Trendy Shoes For Man With High Quality Fabrics And Breathable Outdoor Sport Sneakers Lightweight Air Mesh Men ShoesSneaker for men. Shoes for men. Summer sneaker. Summer shoes for men. shoes for men 2022 Running shoes Casual shoes Sports breathable shoes gym shoes for men walking shoes",
    ...
    {
        id:9,
        name:'Square LED Digital Sports Watch, LED Wrist Watch(null)',
        img:watch1,
        price:105,
        brand:"No Brand",
        category:'watch',
        ratings:4.8,
        allReviews:[
            {user:"jahangir alam",review:"wow amazing"},
            {user:"jahangir alam",review:"wow amazing"},
            {user:"jahangir alam",review:"wow amazing"},
            {user:"jahangir alam",review:"wow amazing"},
        ],
    ...
    {
        id:10,
        name:'100% Pure and Chemical free 1Kg Mustard Flower Honey',
        img:honey1,
        price:301,
        brand:"No Brand",
        category:'honey',
    ...
    {
        id:11,
        name:'Phone Number Plate Auto Vehicle Mobile Phone Number Hanging Key Ring for Bikers - Car - Bike - Home - Office Key Ring - Nice key Ring - key Ring',
        img:ring1,
        price:301,
        brand:"No Brand",
        category:'ring',
        ratings:4.7,
        allReviews:[
            {user:"jahangir alam",review:"onek valo akti product. sobai nite paren"},
            {user:"jahangir alam",review:"ami kinechi valoi ache product ti"},
        ],
        color:"black",
    ...
    {
        id:12,
        name:'জাপানী টমেটার বিজ ১০০ পিস বাসার টবের',
        img:tomato1,
        price:99,
        brand:"No Brand",
        category:'vagitable',
        ratings:4.1,
        allReviews:[
            {user:"jahangir alam",review:"very bad product"},
